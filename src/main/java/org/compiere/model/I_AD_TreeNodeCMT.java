...
public interface I_AD_TreeNodeCMT {
  ...
  String Table_Name = "AD_TreeNodeCMT";
  ...
  String COLUMNNAME_AD_TreeNodeCMT_UU = "AD_TreeNodeCMT_UU";
  /** Column name Created */
  ...
  String getAD_TreeNodeCMT_UU();

  /** Set AD_TreeNodeCMT_UU */
  void setAD_TreeNodeCMT_UU(String AD_TreeNodeCMT_UU);
