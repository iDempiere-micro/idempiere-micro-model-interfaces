...
public interface I_CM_Container {
     ...
     */
    String Table_Name = "CM_Container";
     ...
     */
    String COLUMNNAME_CM_ContainerLink_ID = "CM_ContainerLink_ID";
    /**
     * Column name CM_Container_UU
     */
    String COLUMNNAME_CM_Container_UU = "CM_Container_UU";
    /**
    ...
    I_CM_Container getCM_ContainerLink() throws RuntimeException;

    /**
     * Get CM_Container_UU
     */
    String getCM_Container_UU();

    /**
     * Set CM_Container_UU
     */
    void setCM_Container_UU(String CM_Container_UU);
