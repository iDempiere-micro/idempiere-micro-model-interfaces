 ...
 * @version Release 5.1
 */
public interface AccountingSchema extends PersistentObject {
    ...
    AccountSchemaElement getAcctSchemaElement(String elementType);
    ...
    AccountSchemaElement[] getAcctSchemaElements();
    ...
    DefaultAccountsForSchema getAcctSchemaDefault();
